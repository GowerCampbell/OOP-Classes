"""
--- Employee Onboarding System with String, List, and Dictionary Operations ---
Objective: Build a system that handles employee onboarding data by leveraging string manipulation, list operations, and dictionary usage. This system will manage and process employee information efficiently for HR purposes.

** String Manipulation: 
- Concatenation: We combine employee first name and last name to create a full name.
- Slicing: Extract initials from employee names for easy identification.
- Formatting: We format and display various employee details such as name, age, department, and hobbies in a clean and structured manner.

** Lists:
- We store and manipulate employee hobbies in a list. 
- Basic list operations like indexing, slicing, appending, and removing are used to manage hobbies.
- Sales data is represented as a 2D list where each sublist corresponds to weekly sales for an employee, enabling easy tracking and operations.

** Dictionaries:
- Employee details like name, age, department, address, hobbies, and sales data are stored as key-value pairs in a dictionary.
- We use dictionary operations to update, retrieve, and display employee information efficiently.
"""
"""
